...
function updateDashboardCards() {
  ...
  if (foodTotalInput) foodTotalInput.value = foodTotalCharge;
    ...
    extraRooms: document.getElementById('cust-extra-rooms') ? document.getElementById('cust-extra-rooms').value.trim() : '',
    roomName: document.getElementById('cust-room-name') ? document.getElementById('cust-room-name').value.trim() : '',
    ...
    extraTotal: (parseInt(document.getElementById('cust-extra-person-days').value) || 0) * (parseInt(document.getElementById('cust-extra-person-price').value) || 0) * (parseInt(document.getElementById('cust-extra-person').value) || 0),
    ...
    mainPersonRate: (parseInt(document.getElementById('cust-days').value) || 0) * (parseInt(document.getElementById('cust-capacity').value) || 1 * (parseFloat(document.getElementById('cust-price').value) || 0),
    foodOrders: foodOrdersList,
    foodTotal: typeof foodTotal !== 'undefined' ? foodTotal : 0,
    cabTrips: cabTripsList,
    cabTotal: typeof cabTotal !== 'undefined' ? cabTotal : 0,
