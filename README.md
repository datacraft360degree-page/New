...
<div id="sec-billing-summary" class="bg-blue-50/40 p-3 rounded-2xl border border-blue-100 space-y-2.5 transition-all">
  ...
  <!-- SINGLE LINE ROW FOR ALL 5 EXTRA/ADDITIONAL CHARGES -->
  <div class="grid grid-cols-2 sm:grid-cols-5 gap-2 mb-2 pb-2 border-b border-blue-200">
    <div>
      <label class="block font-semibold text-slate-600 mb-0.5 text-[10px] sm:text-xs truncate">Extra Person Days</label>
      <input type="number" id="cust-extra-person-days" readonly="" class="w-full bg-slate-200/60 font-bold text-slate-700 border border-slate-200 rounded-xl px-2 py-1.5 cursor-not-allowed text-xs sm:text-sm" value="0" />
    </div>
    <div>
      <label class="block font-semibold text-slate-600 mb-0.5 text-[10px] sm:text-xs truncate">Extra Person Price/Day</label>
      <input type="number" id="cust-extra-person-price" readonly="" class="w-full bg-slate-200/60 font-bold text-slate-700 border border-slate-200 rounded-xl px-2 py-1.5 cursor-not-allowed text-xs sm:text-sm" value="1200" />
    </div>
    <div>
      <label class="block font-semibold text-slate-600 mb-0.5 text-[10px] sm:text-xs truncate">Extra Person Rate (₹)</label>
      <input type="number" id="cust-extra-total" readonly="" class="w-full bg-slate-200/60 font-bold text-slate-700 border border-slate-200 rounded-xl px-2 py-1.5 cursor-not-allowed text-xs sm:text-sm" />
    </div>
    <div>
      <label class="block font-semibold text-slate-600 mb-0.5 text-[10px] sm:text-xs truncate">Cab Fare (₹)</label>
      <input type="number" id="cust-cab-total" readonly="" class="w-full bg-slate-200/60 font-bold text-slate-700 border border-slate-200 rounded-xl px-2 py-1.5 cursor-not-allowed text-xs sm:text-sm" />
    </div>
    <div>
      <label class="block font-semibold text-slate-600 mb-0.5 text-[10px] sm:text-xs truncate">Extra Food/Drink (₹)</label>
      <input type="number" id="cust-food-total" readonly="" class="w-full bg-slate-200/60 font-bold text-amber-700 border border-slate-200 rounded-xl px-2 py-1.5 cursor-not-allowed text-xs sm:text-sm" value="0" />
    </div>
  </div>

  <!-- MAIN RESERVATION BILLING ROW -->
  <div class="grid grid-cols-2 sm:grid-cols-6 gap-2">
    <div>
      <label class="block font-semibold text-slate-600 mb-0.5">Days</label>
      <input type="number" id="cust-days" readonly="" onchange="syncBillingValues()" class="w-full bg-slate-200/60 font-bold text-slate-700 border border-slate-200 rounded-xl px-2 py-1.5 cursor-not-allowed" />
    </div>
    <div>
      <label class="block font-semibold text-slate-600 mb-0.5">Price/Day (₹)</label>
      <input type="number" id="cust-price" value="1200" oninput="syncBillingValues(); calculateModalBilling();" class="w-full bg-white font-bold text-slate-700 border border-slate-200 rounded-xl px-2 py-1.5 focus:outline-none focus:border-blue-500" />
    </div>
    <div>
