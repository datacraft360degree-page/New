...
<!-- FULL SCREEN BIRTHDAY overlay WITH HANGING RIBBON BANNERS & FLOATING BALLOONS -->
<div id="birthday-overlay" class="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-slate-900/90 backdrop-blur-md overflow-hidden p-4 no-print transition-opacity duration-500">
  
  <!-- Hanging Ribbon Banner Top Decorative Bar -->
  <div class="absolute top-0 inset-x-0 flex justify-around items-start pointer-events-none z-10 overflow-hidden">
    <div class="w-12 h-24 bg-gradient-to-b from-rose-500 to-rose-600 rounded-b-full shadow-lg transform -translate-y-2 animate-bounce" style="animation-duration: 2.5s;"></div>
    <div class="w-12 h-32 bg-gradient-to-b from-amber-400 to-amber-500 rounded-b-full shadow-lg transform -translate-y-4 animate-bounce" style="animation-duration: 2s;"></div>
    <div class="w-12 h-20 bg-gradient-to-b from-blue-500 to-blue-600 rounded-b-full shadow-lg transform -translate-y-1 animate-bounce" style="animation-duration: 3s;"></div>
    <div class="w-12 h-28 bg-gradient-to-b from-emerald-500 to-emerald-600 rounded-b-full shadow-lg transform -translate-y-3 animate-bounce" style="animation-duration: 2.2s;"></div>
    <div class="w-12 h-24 bg-gradient-to-b from-purple-500 to-purple-600 rounded-b-full shadow-lg transform -translate-y-2 animate-bounce" style="animation-duration: 2.7s;"></div>
  </div>

  <!-- Festive Banner String Text -->
  <div class="absolute top-10 z-20 text-center w-full">
    <span class="bg-amber-400 text-slate-900 font-black text-sm uppercase px-4 py-1.5 rounded-full shadow-xl tracking-widest border-2 border-white animate-pulse">
      🎉 HURRAY! IT'S A SPECIAL DAY! 🎉
    </span>
  </div>

  <!-- Floating Balloons Container -->
  <div class="absolute inset-0 pointer-events-none overflow-hidden" id="balloon-container"></div>

  <!-- Festive Celebration Card -->
  <div class="relative z-30 bg-white/95 border-2 border-amber-300 rounded-3xl p-6 md:p-8 max-w-lg w-full text-center shadow-2xl space-y-4 transform scale-100 transition-all">
    <div class="w-16 h-16 bg-gradient-to-tr from-amber-400 to-rose-500 text-white text-3xl rounded-full flex items-center justify-center mx-auto shadow-lg animate-bounce">
      🎂
    </div>
    ...
    <button onclick="closeBirthdayOverlay()" class="mt-2 bg-gradient-to-r from-rose-500 via-amber-500 to-emerald-500 text-white font-black text-xs uppercase px-8 py-3 rounded-2xl shadow-lg hover:brightness-110 active:scale-95 transition-all cursor-pointer">
      🎈 Let's Celebrate! 🥳
    </button>
  </div>
</div>
...
function isBirthdayToday() {
  ...
  const month = today.getMonth(); // Months are 0-indexed (0 = Jan, 7 = Aug)
  const date = today.getDate();

  // Check if Month is August (7) and Date is 21
...
function generateBalloons() {
  ...
  // Keyframe CSS injection for rising balloons
